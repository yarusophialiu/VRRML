...
if __name__ == "__main__":
    ...
    model_pth_path = ""
    folder = 'ML/reference256x256' # reference64x64 # TODO change model size reference128x128
    ...
    batch_size = 128 # TODO
    patch_size = (256, 256) # TODO, change patch structure in DecRefClassification.py
